...
mkdir -p /home/backup/backup/client1/$(date +%Y-%m-%d)/
mkdir -p /home/backup/backup/client2/$(date +%Y-%m-%d)/
rsync "$ziel/backupclient1.tar.gz" /home/backup/backup/client1/$(date +%Y-%m-%d)/ #--link-dest="/home/backup/backup/client1/tag/vordere_sicherung"

rsync "$ziel/backupclient2.tar.gz" /home/backup/backup/client2/$(date +%Y-%m-%d)/ #--link-dest="/home/backup/backup/client2/tag/vordere_sicherung"
